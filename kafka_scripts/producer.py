...
while True:
    ...
    if delta1.seconds >= 1 :
        ...
        producer.send('TutorialTopic', s1)
        producer.send('TutorialTopic', s2)
        producer.send('TutorialTopic', s3)
        producer.send('TutorialTopic', s4)
        producer.send('TutorialTopic', s5)
        producer.send('TutorialTopic', s6)
